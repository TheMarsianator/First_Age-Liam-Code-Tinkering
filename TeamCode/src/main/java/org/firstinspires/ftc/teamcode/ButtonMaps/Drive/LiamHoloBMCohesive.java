...
public class LiamHoloBMCohesive extends AbstractButtonMap {
    double fow = 0;
    double str = 0;
    double tu = 0;
    ...
    public void loop(FirstAgeTempbot robot, OpMode opMode) {
        ...
        MotorPowers mp = robot.omniDrive(str + opMode.gamepad1.left_stick_y, fow + opMode.gamepad1.left_stick_x, tu + opMode.gamepad1.right_stick_x, .8);
