...
@Config
public class MecanumDriveNoMotors {
...
//    public final Localizer localizer;
    ...
    public abstract class DriveLocalizer implements Localizer {
...
//            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveNoMotors.this.leftFront));
//            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveNoMotors.this.leftBack));
//            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveNoMotors.this.rightBack));
//            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveNoMotors.this.rightFront));
...
//    public MecanumDriveNoMotors(HardwareMap hardwareMap, Pose2d pose) {
//        this.pose = pose;
