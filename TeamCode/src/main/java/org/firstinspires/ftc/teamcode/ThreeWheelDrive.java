...
public class ThreeWheelDrive {
    ...
    public final DcMotorEx leftBack, rightBack;
    ...
    public class DriveLocalizer implements Localizer {
        public final Encoder leftBack, rightBack;
        ...
        public DriveLocalizer() {
            leftBack = new OverflowEncoder(new RawEncoder(ThreeWheelDrive.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(ThreeWheelDrive.this.rightBack));
        ...
        public Twist2dDual<Time> update() {
            ...
            FlightRecorder.write("MECANUM_LOCALIZER_INPUTS", new MecanumLocalizerInputsMessage(
                    leftBackPosVel, leftBackPosVel, rightBackPosVel,rightBackPosVel, angles));
    ...
    public ThreeWheelDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
...
//        leftBack.setDirection(DcMotorSimple.Direction.REVERSE);
 //Bonk+
    ...
    public void setMotorPowers(TrikeMotorPowers mp){
        setMotorPower(mp.leftBack, mp.rightBack);
    }
    ...
    public void setMotorPower(double powLeftBack, double powRightBack){
